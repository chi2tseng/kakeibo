...
/* 日文食材 → 中文翻譯（依關鍵字，先具體後籠統） */
const ZH_GLOSS = [
  ['モモニク','雞腿肉'],['もも肉','雞腿肉'],['モモ肉','雞腿肉'],['ムネニク','雞胸肉'],['胸肉','雞胸肉'],['ささみ','雞柳'],['手羽','雞翅'],
  ['ワカドリ','雞肉'],['若鶏','雞肉'],['チキン','雞肉'],['鶏','雞肉'],['とり肉','雞肉'],
  ['豚バラ','豬五花'],['豚','豬肉'],['ぶた','豬肉'],['ブタ','豬肉'],['ポーク','豬肉'],
  ['黒毛和牛','和牛'],['和牛','和牛'],['牛肉','牛肉'],['カルビ','牛小排'],['ロース','里肌'],['バラ','五花'],['挽肉','絞肉'],['ひき肉','絞肉'],['ステーキ','牛排'],['ラム','羊肉'],['火鍋肉','火鍋肉片'],['肉片','肉片'],
  ['ムキエビ','蝦仁'],['エビ','蝦'],['蝦','蝦'],['サーモン','鮭魚'],['鮭','鮭魚'],['マグロ','鮪魚'],['鮪','鮪魚'],['サバ','鯖魚'],['鯖','鯖魚'],['イカ','花枝'],['タコ','章魚'],['ホタテ','干貝'],['牡蠣','牡蠣'],['ぶり','鰤魚'],['ブリ','鰤魚'],['あさり','蛤蜊'],['しらす','吻仔魚'],['刺身','生魚片'],['サシミ','生魚片'],['生魚片','生魚片'],['寿司','壽司'],['壽司','壽司'],['鯛','鯛魚'],
  ['サラダチキン','舒肥雞'],['ベーコン','培根'],['ハム','火腿'],['ウインナー','香腸'],['ウィンナー','香腸'],['ソーセージ','香腸'],
  ['ヨーグルト','優格'],['モッツァレラ','起司'],['チーズ','起司'],['牛乳','牛奶'],['ギュウニュウ','牛奶'],['ニュウギュウ','牛奶'],['ミルク','牛奶'],['ラクノウ','牛奶'],['生クリーム','鮮奶油'],['純生','鮮奶油'],['純乳脂','鮮奶油'],
  ['赤たまご','雞蛋'],['たまご','雞蛋'],['玉子','雞蛋'],['卵','雞蛋'],['エッグ','雞蛋'],
  ['豆腐','豆腐'],['とうふ','豆腐'],['キヌ','嫩豆腐'],['納豆','納豆'],['厚揚げ','油豆腐'],['油揚げ','油豆腐'],
  ['食パン','吐司'],['マフィン','馬芬'],['ベーグル','貝果'],['クロワッサン','可頌'],['バウム','年輪蛋糕'],['ブレッド','麵包'],['パン','麵包'],
  ['バナナ','香蕉'],['いちご','草莓'],['苺','草莓'],['あまおう','草莓'],['サンふじ','蘋果'],['りんご','蘋果'],['ふじ','蘋果'],['キウイ','奇異果'],['ぶどう','葡萄'],['ブルーベリー','藍莓'],['メロン','哈密瓜'],['すいか','西瓜'],['みかん','橘子'],['オレンジ','柳橙'],['レモン','檸檬'],['マンゴー','芒果'],['桃','桃子'],['梨','梨'],['なし','梨'],
  ['レタス','萵苣'],['キャベツ','高麗菜'],['きゅうり','小黃瓜'],['キュウリ','小黃瓜'],['ズッキーニ','櫛瓜'],['玉ねぎ','洋蔥'],['タマネギ','洋蔥'],['ねぎ','蔥'],['ネギ','蔥'],['ニラ','韭菜'],['なす','茄子'],['もやし','豆芽'],['にんにく','大蒜'],['ニンニク','大蒜'],['ほうれん','菠菜'],['ブロッコリー','花椰菜'],['しめじ','鴻喜菇'],['えのき','金針菇'],['まいたけ','舞菇'],['マッシュルーム','蘑菇'],['しいたけ','香菇'],['白菜','白菜'],['大根','白蘿蔔'],['にんじん','紅蘿蔔'],['人参','紅蘿蔔'],['ピーマン','青椒'],['パプリカ','甜椒'],['トマト','番茄'],['番茄','番茄'],['アボカド','酪梨'],['かぼちゃ','南瓜'],['ごぼう','牛蒡'],['れんこん','蓮藕'],['セロリ','芹菜'],['リーフ','生菜'],
  ['弁当','便當'],['便當','便當'],['おにぎり','飯糰'],['サラダ','沙拉'],['唐揚げ','炸雞'],['から揚げ','炸雞'],['炒飯','炒飯'],['丼','蓋飯'],['グラタン','焗烤'],['コロッケ','可樂餅'],['サンド','三明治'],
];
function zhGloss(seg){ const s=seg.toLowerCase(); for(const [k,zh] of ZH_GLOSS) if(s.includes(k.toLowerCase())) return zh; return ''; }
...
function estimateInventory(tx, today){
  ...
  for(const t of tx){
    ...
    for(const seg of segs){
      ...
      raw.push({ name:cleanItem(seg)||r.group, zh:zhGloss(seg)||r.group, group:r.group, icon:r.icon, date:t.date, payer:t.payer, shelf, left });
    }
  }
  // 同品項只留最近一次採購（重買=補貨）
  const map={};
